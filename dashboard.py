...
"")
        ...
        self.debt_tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.debt_tableWidget.setGeometry(QtCore.QRect(30, 341, 481, 211))
        self.debt_tableWidget.setObjectName("debt_tableWidget")
        self.debt_tableWidget.setColumnCount(0)
        self.debt_tableWidget.setRowCount(0)
        self.add_expense_button = QtWidgets.QPushButton(self.centralwidget)
        self.add_expense_button.setGeometry(QtCore.QRect(400, 270, 90, 29))
