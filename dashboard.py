...
"")
        ...
        self.debt_tableView = QtWidgets.QTableWidget(self.centralwidget)
        self.debt_tableView.setGeometry(QtCore.QRect(30, 341, 481, 211))
        self.debt_tableView.setObjectName("debt_tableWidget")
        self.debt_tableView.setColumnCount(0)
        self.debt_tableView.setRowCount(0)
